"""
LLM-Enhanced Search Engine for ROS Component Explorer.

This module provides intelligent search capabilities by combining:
1. Natural language query processing
2. Structured search execution
3. LLM-powered result synthesis and ranking
...
class LLMSearchEngine:
    ...
    def __init__(self, ttl_file: str, use_local_llm: bool = True):
        ...
        Args:
            ...
            use_local_llm: Whether to use local LLM processing (vs external API)
        """
        ...
        self.translator = QueryToSearchTranslator()
