"""
Rule-Based Natural Language Query Processor for ROS Component Explorer.

This module enables structured natural language querying of the ROS component database by:
1. Using pattern matching to parse natural language queries and extract component requirements
2. Translating requirements into structured search parameters using predefined rules
...
class NLQueryProcessor:
    """
    Rule-based Natural Language Query Processor for ROS components.
    
    Uses pattern matching and keyword extraction to understand user queries,
    not actual natural language processing or machine learning.
    """
